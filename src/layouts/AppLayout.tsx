...
export const AppLayout: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const activeClass = (path: string) => {
    return location.pathname === path
      ? 'bg-brand-50 text-brand-600 border-l-4 border-brand-500 font-semibold'
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex">
      ...
      {/* Sidebar Component */}
      <aside
        className={`fixed inset-y-0 left-0 z-50 w-64 bg-white border-r border-slate-200 flex flex-col transition-transform duration-300 transform lg:translate-x-0 lg:static lg:h-screen ${
      ...
      >
        ...
        {isMock && (
          <div className="p-4 mx-4 mb-3 bg-slate-50 border border-slate-200 rounded-xl">
        ...
        <div className="p-4 border-t border-slate-100 bg-slate-50/50 flex flex-col gap-2">
          ...
          <button
            ...
            className="flex items-center gap-3 px-4 py-2.5 rounded-lg text-sm text-red-600 hover:bg-red-50 transition-all font-medium mt-1 w-full text-left"
          >
      ...
      <div className="flex-1 flex flex-col min-w-0 h-screen overflow-hidden">
        ...
        <header className="h-16 bg-white border-b border-slate-200 flex items-center justify-between px-6 z-30 flex-shrink-0">
          <div className="flex items-center gap-4">
            ...
            <h1 className="font-bold text-lg text-slate-800 hidden md:block capitalize">
          ...
          <div className="flex items-center gap-4">
            {/* Quick Helper info */}
            <span className="text-xs text-slate-400 bg-slate-100 px-2 py-1 rounded hidden sm:inline-block">
            ...
            <div className="relative">
              ...
              {notificationsOpen && (
                <>
                  ...
                  <div className="absolute right-0 mt-2 w-80 bg-white border border-slate-200 rounded-xl shadow-xl z-50 p-4 animate-fade-in">
                    ...
                    <div className="space-y-3 max-h-60 overflow-y-auto scrollbar-thin">
                      <div className="p-2 rounded-lg bg-slate-50 border border-slate-100 hover:bg-slate-100/50 transition">
                        <p className="text-xs font-semibold text-slate-800">New Study Guide Generated</p>
                        <p className="text-[10px] text-slate-500 mt-0.5">Gemini generated flashcards for your uploaded notes.</p>
                      </div>
                      <div className="p-2 rounded-lg bg-slate-50 border border-slate-100 hover:bg-slate-100/50 transition">
                        <p className="text-xs font-semibold text-slate-800">Quiz Completed</p>
                        <p className="text-[10px] text-slate-500 mt-0.5">You scored 8/10 on the Database Systems quiz.</p>
                      </div>
                    </div>
                  </div>
                </>
            ...
            <div className="relative">
              ...
              {profileDropdownOpen && (
                <>
                  ...
                  <div className="absolute right-0 mt-2 w-48 bg-white border border-slate-200 rounded-xl shadow-xl z-50 py-1.5 animate-fade-in">
        ...
        <main className="flex-1 overflow-y-auto scrollbar-thin bg-slate-50 p-6 md:p-8">
